...
See the [review angle reference](/docs/concepts/review-angles) for each lens. The detector owns the
exact selection heuristics; worker prompt frontmatter owns model tiers.
